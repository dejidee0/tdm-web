...
export default function AIMultiModeShowcase() {
  ...
  return (
    <section className="bg-black py-16 px-4 sm:px-6 font-manrope">
      ...
      {/* Grid */}
      <div className="max-w-275 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-24">
        ...
        <motion.div {...fadeUp(0.1)} className="flex flex-col gap-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[#D4AF37] text-xs font-bold tracking-[0.18em] uppercase">
              Text to Image
            </span>
          </div>
          ...
          {/* Prompt card */}
          <div
            className="relative border rounded-2xl px-5 py-5"
            style={{ background: "#0d0b08", borderColor: "rgba(255,255,255,0.08)" }}
          >
            {/* Quote badge */}
            <div
              className="absolute -top-3.5 left-4 w-8 h-8 rounded-lg flex items-center justify-center"
            ...
            <p className="text-white text-sm sm:text-base leading-relaxed pt-2">
        ...
        <motion.div {...fadeUp(0.2)} className="relative">
          <div className="relative rounded-3xl overflow-hidden h-70 sm:h-80 lg:h-full min-h-70">
            <Image
              src={KITCHEN_IMAGE}
            ...
            <div className="absolute bottom-4 left-4">
              <span
                className="text-white text-xs font-bold px-4 py-2 rounded-full tracking-wide"
        ...
        <motion.div {...fadeUp(0.3)} className="relative">
          <div
            className="relative rounded-3xl overflow-hidden h-70 sm:h-80 group cursor-pointer"
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            <div
              className="rounded-2xl px-5 py-4 text-center border border-white/08"
              style={{ background: "#0d0b08" }}
            >
              <div className="text-white text-2xl font-extrabold mb-0.5">
                4K
              </div>
              <div className="text-white/30 text-xs font-bold tracking-[0.15em] uppercase">
                Resolution
              </div>
            </div>
            <div
