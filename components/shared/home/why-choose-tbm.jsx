          ...
          <Reveal direction="up" delay={140}>
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                <Link href="/ziora" className="btn-gold gap-2">
                  Start with Ziora
          ...
          {TESTIMONIALS.slice(1).map((t, i) => (
            <Reveal key={t.name} direction="up" delay={i * 100}>
              ...
              >
                ...
                <div>
                  <p className="text-white text-[13px] font-manrope font-semibold">
                    {t.name}
                  </p>
                  <p className="text-[#D4AF37] text-[16px] font-manrope tracking-[0.14em] uppercase mt-0.5">
                    {t.title}
                  </p>
                </div>
              </div>
