      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16">
        ...
        <Reveal direction="up">
          <div className="text-center mb-4">
            <h2 className="font-poppins font-bold text-3xl sm:text-4xl lg:text-5xl text-white">
              The TBM <span className="text-[#D4AF37]">Transformation</span>
            </h2>
          </div>
        </Reveal>
        ...
        <Reveal direction="up" delay={80}>
          <p className="text-center text-white/40 text-sm sm:text-base font-manrope max-w-xl mx-auto mb-14 sm:mb-18">
            Witness the precision of our construction and interior team as we
            restore raw structures into architectural masterpieces.
          </p>
        </Reveal>
