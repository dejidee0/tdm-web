...
export default function ProductCard({ product }) {
  ...
  const renderBadge = (badge) => {
    const badgeStyles = {
      "Best Seller": "bg-[#1e293b] text-white",
  ...
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
      ...
      <div className="p-4">
        ...
        {/* Product Name */}
        <h3 className="font-semibold font-manrope text-[#0E1B13] mb-2">
          {product.name}
        </h3>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 flex-1">
          ...
          <button className="flex items-center gap-2 px-4 py-2 bg-gray-200 border border-gray-300 rounded-lg text-sm font-semibold text-primary hover:bg-gray-50 transition-colors w-full sm:w-auto justify-center">
            <svg
              className="w-4 h-4"
              fill="none"
              stroke="currentColor"
