        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse 80% 80% at 100% 50%, rgba(212,175,55,0.08) 0%, transparent 70%)",
              }}
            />
            <div className="relative z-10">
              <span className="text-[16px] font-bold text-[#D4AF37] uppercase tracking-[0.2em] mb-4 block">
                New here
              </span>
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse 80% 80% at 0% 50%, rgba(212,175,55,0.12) 0%, transparent 70%)",
              }}
            />
            <div className="relative z-10">
              <span className="text-[16px] font-bold text-[#D4AF37] uppercase tracking-[0.2em] mb-4 block">
