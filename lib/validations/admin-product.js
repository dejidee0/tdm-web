...
export function productToFormValues(p) {
  return {
    ...
    // keyFeatures is returned on read; whatsIncluded/whatsNotIncluded and
    // specifications are not (they read back null), so edit starts them empty
    // and saving overwrites — the form's "Ordering & SEO" warning applies here
    // too. Prefill whatever the API does return.
