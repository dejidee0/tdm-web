...
export const BOGAT_PRODUCTS = [
  ...
  // ── 1. Modern Vanity Set (Bogat) ─────────────────────────────────────────
  {
    ...
    features: [
      ...
      { icon: "star",  label: "Modern Design",                  description: "Sleek, stylish & elegant finish" },
  ...
  // ── 2. Wall Mounted Basin Mixer (Bogat) ──────────────────────────────────
  {
    ...
    features: [
      ...
      { icon: "star",  label: "Luxury Finish",               description: "Elegant brushed gold finish" },
  ...
  // ── 3. Modern Vanity Combo (XM Bathroom) ─────────────────────────────────
  {
    ...
    features: [
      { icon: "star",  label: "LED Lighting",    description: "Warm & bright ambiance" },
  ...
  // ── 4. Premium LED Vanity Cabinet (Bogat) ────────────────────────────────
  {
    ...
    features: [
      { icon: "diamond",   label: "Premium Materials",              description: "High-quality & durable" },
      { icon: "waterproof", label: "Waterproof & Moisture Resistant", description: "Built for humid environments" },
      { icon: "star",  label: "Modern Aesthetic",              description: "Sleek, stylish & timeless look" },
  ...
  // ── 5. Smart Wall Hung Toilet (Bogat) ────────────────────────────────────
  {
    ...
    features: [
      { icon: "star",  label: "Smart Technology", description: "Advanced functionality" },
  ...
  // ── 6. Waterfall Kitchen Faucet (Bogat) ──────────────────────────────────
  {
    ...
    features: [
      ...
      { icon: "star",  label: "Flexible Neck",               description: "Easy reach & movement" },
  ...
  // ── 7. Luxury Freestanding Bathtub (Bogat) ───────────────────────────────
  {
    ...
    features: [
      ...
      { icon: "star",  label: "Smooth Finish",     description: "Easy to clean surface" },
  ...
  // ── 8. Flexible Neck Kitchen Faucet (Bogat) ──────────────────────────────
  {
    ...
    features: [
      { icon: "diamond",   label: "Premium Brass",       description: "High-quality & durable" },
      { icon: "star",  label: "Luxury Finish",       description: "Stylish modern texture" },
  ...
  // ── 9. Bathroom Accessory Set (Bogat) ────────────────────────────────────
  {
    ...
    features: [
      ...
      { icon: "star",  label: "Easy Installation",  description: "Strong & secure mounting" },
    ],
