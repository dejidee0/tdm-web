...
export const roleBadgeColors = {
  Admin: { bg: "bg-[#C4B5FD]", text: "text-[#475569]" },
  Vendor: { bg: "bg-[#86EFAC]", text: "text-[#475569]" },
  Customer: { bg: "bg-[#CBD5E1]", text: "text-[#475569]" },
  Auditor: { bg: "bg-[#F9A8D4]", text: "text-[#475569]" },
  Manager: { bg: "bg-[#93C5FD]", text: "text-[#475569]" },
};
