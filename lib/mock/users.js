...
export const mockUsers = Array.from({ length: 452 }, (_, index) => {
  ...
  return {
    ...
    role,
    isActive,
    avatar: index < 20 ? `/avatars/sarah.png` : null, // First 20 have images
...
export const roleBadgeColors = {
  Admin: { bg: "bg-[#312E8166]", text: "text-[#273054]" },
  Vendor: { bg: "bg-[#064E3B66]", text: "text-[#273054]" },
  Customer: { bg: "bg-[#1E3A8A66]", text: "text-[#273054]" },
  Auditor: { bg: "bg-[#78350F66]", text: "text-[#273054]" },
  Manager: { bg: "bg-[#93C5FD]", text: "text-[#273054]" },
};
