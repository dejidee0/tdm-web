...
export const severityColors = {
  CRITICAL: { bg: "bg-[#FEE2E2]", text: "text-[#991B1B]", badge: "bg-[#FEE2E2] text-[#DC2626]" },
  ERROR: { bg: "bg-[#FEF3C7]", text: "text-[#92400E]", badge: "bg-[#FED7AA] text-[#EA580C]" },
  WARNING: { bg: "bg-[#FEF3C7]", text: "text-[#92400E]", badge: "bg-[#FED7AA] text-[#EA580C]" },
  INFO: { bg: "bg-[#DBEAFE]", text: "text-[#1E40AF]", badge: "bg-[#DBEAFE] text-[#2563EB]" },
};
