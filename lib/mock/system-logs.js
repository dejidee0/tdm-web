...
// Users/Actors
const actors = [
  { name: "System", initials: "S", type: "system", colorScheme: { bg: "#64748B", text: "#FFFFFF" } },
  { name: "j.doe@tbm.co", initials: "JD", type: "user", colorScheme: { bg: "#1E3A8A", text: "#FFFFFF" } },
  { name: "Unknown", initials: "U", type: "unknown", colorScheme: { bg: "#334155", text: "#FFFFFF" } },
  { name: "auto_bot", initials: "AB", type: "bot", colorScheme: { bg: "#581C87", text: "#FFFFFF" } },
  { name: "m.k@client.com", initials: "MK", type: "user", colorScheme: { bg: "#059669", text: "#FFFFFF" } },
];
...
export const severityColors = {
  CRITICAL: { bg: "bg-[#FEE2E2]", text: "text-[#991B1B]", badge: "bg-[#EF4444]/10 border border-[#EF4444]/20 text-[#F87171]" },
  ERROR: { bg: "bg-[#FEF3C7]", text: "text-[#92400E]", badge: "bg-[#F97316]/10 border border-[#F97316]/20 text-[#FB923C]" },
  WARNING: { bg: "bg-[#FEF3C7]", text: "text-[#92400E]", badge: "bg-[#EAB308]/10 border border-[#EAB308]/20 text-[#FACC15]" },
  INFO: { bg: "bg-[#DBEAFE]", text: "text-[#1E40AF]", badge: "bg-[#3B82F6]/10 border border-[#3B82F6]/20 text-[#60A5FA]" },
};
