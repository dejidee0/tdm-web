...
export async function getCurrentAdminUser() {
  try {
    ...
    cookieStore.set("adminBearerToken", newAccessToken, { ...cookieOpts, httpOnly: false });
    if (newRefreshToken) {
      cookieStore.set("adminRefreshToken", newRefreshToken, { ...cookieOpts, httpOnly: true });
    }
...
export async function adminLogout() {
  ...
  try {
    const bearerToken = cookieStore.get("adminBearerToken")?.value;
