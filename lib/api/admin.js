...
/**
 * Admin Pricing API
 * Spec: GET /admin/pricing, PUT /admin/pricing/:tier
 */
export const adminPricingAPI = {
  // GET /admin/pricing — returns all PricingConfig records
  getAll: async () => {
    const response = await apiClient.get("/admin/pricing");
    return response.data;
  },

  // PUT /admin/pricing/:tier — update pricing config for a tier
  updateTier: async (tier, data) => {
    const response = await apiClient.put(`/admin/pricing/${tier}`, data);
    return response.data;
  },
};
...
/**
 * Admin Discounts API
 * Spec: GET/POST /admin/discounts, PUT/DELETE /admin/discounts/:id
 */
export const adminDiscountsAPI = {
  // GET /admin/discounts — list all discount campaigns
  // ?status=active|scheduled|expired|all, ?tier=premium|luxury
  getAll: async (params) => {
    const response = await apiClient.get("/admin/discounts", { params });
    return response.data;
  },

  // POST /admin/discounts — create a new discount campaign
  create: async (data) => {
    const response = await apiClient.post("/admin/discounts", data);
    return response.data;
  },

  // PUT /admin/discounts/:id — update a discount
  update: async (id, data) => {
    const response = await apiClient.put(`/admin/discounts/${id}`, data);
    return response.data;
  },

  // DELETE /admin/discounts/:id — soft-delete (deactivate) a discount
  remove: async (id) => {
