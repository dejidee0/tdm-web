...
// Authenticated sessions ride the httpOnly authToken cookie, which lib/proxy.js
// converts into an Authorization header server-side.
...
function normaliseBackendCart(raw) {
  ...
  return {
    ...
    guestSessionId: root.guestSessionId ?? null,
    items,
    subtotal,
    shipping: 0,
    taxRate: TAX_RATE,
