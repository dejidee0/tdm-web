...
export const designsApi = {
  ...
  getDesigns: ({ page, pageSize } = {}) => {
    ...
    return proxyFetch(`/designs${query ? `?${query}` : ""}`).then((data) => {
      console.log("[designs] getDesigns:", data);
      return data;
    });
  },
  ...
  getPublicDesigns: async (params = {}) => {
    ...
    console.log("[designs] getPublicDesigns raw response:", data);
    return data;
  },
};
...
export const designSessionsApi = {
   ...
   */
  getSessions: () =>
    proxyFetch("/designs/sessions").then((data) => {
      console.log("[designs] getSessions:", data);
      return data;
    }),
