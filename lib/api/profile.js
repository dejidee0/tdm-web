...
export const profileApi = {
  ...
  // ── Change phone ──────────────────────────────────────────────────────────
  updatePhone: (data) =>
    apiFetch("/api/account/phone", {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(data),
    }),

  // ── Direct password change (no OTP, requires currentPassword) ─────────────
  ...
  // ── OTP-based password change (uses existing route handler) ───────────────
  ...
  setDefaultAddress: (addressId) =>
    apiFetch(`/api/account/addresses/${addressId}/default`, { method: "PUT" }),
